	...
	<div>
		<div class="halfarea-1">
			...
			<div class="box3">
				...
				<div>
					<span @click="forSavings" @mouseenter="mouall(3)" @mouseleave="leaveall(3)">SAVING</span>
			...
			<div class="box5" v-if="(loginstate != '') & (loginstate != null)">
				...
				<div style="height: 100%;" @mouseleave="leavekuang3"><div class="shou dashboadr" @mouseenter="forkuang3"  @click="formyaccount">Dash board</div></div>
