	...
	<div>
		<div class="all">
			<div class="all-1">
				...
				<div class="all-1-2">
					<img src="../../static/password1.png"  class="img1"/>
					<div class="all-1-3">For security purposes,no withdrawals are permitted for 24hours after modification of security methods.</div>
				</div>
				<div class="all-1-4">
					<el-input placeholder="newpassword" v-model="passwordval" show-password class="xuanze" @input="usepassword" @blur="yspasswordval"></el-input>
	...
	methods: {
		...
		queren() {
			...
			return false
				...
				https
					.fetchPost('/account/rstPwd', params)
					.then(data => {
						...
						if(data.data.msg=="SUCCESS"){
							...
							this.$alert('Please resend the activation email to change the password', {
								confirmButtonText: 'OK'
							});
						}
					})
