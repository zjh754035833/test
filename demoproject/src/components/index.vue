<template>
  <div class="all">
    <div class="toparea">
      <div class="text1" v-for="item in list">
        <div>{{ item.msg }}</div>
    ...
    <div class="bottomarea5">
       ...
       <div class="bottomarea5-2">
        <div>
          <div>Streamlined</div>
           <div>Buy crypto and deposit it directly to your Auwels wallet: start trading on the world’s leading crypto exchange in an instant! Once you use one of the options above to buy Bitcoin and other crypto, your purchased crypto will go directly to your Auwels account.</div>
        </div>
        <div >
          <img  src="../../static/S4.png" />
        </div>
        <div >
          <div>Reliable</div>
      ...
      <div>
        <div>Many Options</div>
         <div>Pick from the various payment methods here. Buy Bitcoin with credit card (You can also buy XRP, ETH, LTC and BCH), or buy crypto with US Dollars or Euro through TUSD or PAX stablecoins. You also have options to turn your TUSD or PAX back into cash.</div>
      </div>
        <div><img src="../../static/S2.png" class="imgs2"></div>
       </div>
    </div>
<v-footer></v-footer>
  </div>
      ...
      tableData: [
        {
          ...
          text3: '$19.2',
          text4: '-1.04',
          img5: '../../static/Path5.png'
        },

        {
          img: '../../static/Bitmap (6).png',
          text1: 'BNB',
          text2: 'BNB',
          text3: '$19.2',
          text4: '+1.04',
