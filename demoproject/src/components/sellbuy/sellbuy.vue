<template>
	<div>
		...
		<el-dialog title="" :visible.sync="dixdiag.changeprice" width="60%" top="0" :before-close="buy5cancel">
			...
			<div class="buy4all">
				<div class="buy4all-1">
					<div class="buy4all-1-1">
						<div class="shou" @click="forbuy4type(1)"><img src="../../../static/newbuysell0.png" v-if="t1 == true" /></div>
						<div class="shou" @click="forbuy4type(2)"><img src="../../../static/newbuysell0.png" v-if="t2 == true" /></div>
						<div class="shou" @click="forbuy4type(3)"><img src="../../../static/newbuysell0.png" v-if="t3 == true" /></div>
					</div>
		...
		<el-dialog title="" :visible.sync="dixdiag.buy1" width="60%" top="0" :before-close="handleClose1">
			...
			<div class="buy1all">
				...
				<div class="bu1-3">
					<img src="../../../static/buyt2.png" @click="buyt2()" class="shou" />
					<img src="../../../static/buyt1.png" @click="buyt1()" class="shou" />
				</div>
				<div class="bu1-4">
